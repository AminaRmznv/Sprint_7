...
class TestCourierCreation:
    ...
    @allure.description(
        "Проверка успешного создания заказа с различными цветами:можно указать один из цветов — BLACK или GREY, "
        "можно указать оба цвета. Тело ответа содержит track")
    @pytest.mark.parametrize("colors", [["BLACK"], ["GREY"], ["BLACK", "GREY"]])
    def test_order_creation_with_various_colors_success(self, colors):
        payload = {
            "firstName": "Naruto",
            "lastName": "Uchiha",
    ...
    def test_order_creation_without_color_success(self):
        payload = {
            "firstName": "Naruto",
            "lastName": "Uchiha",
            "address": "Konoha, 142 apt.",
