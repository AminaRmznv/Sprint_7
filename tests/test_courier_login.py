import allure
import requests
from urls import API_URL_LOGIN
...
class TestCourierCreation:
    ...
    def test_login_courier_with_valid_data_success(self, create_new_courier_and_return_data):
    ...
    def test_login_courier_with_invalid_data_returns_error(self, create_new_courier_and_return_data):
        login, password, first_name = create_new_courier_and_return_data
        payload = {
            "login": login+"1",
            "password": password+"1"
    ...
    def test_login_courier_missing_fields_returns_error(self, create_new_courier_and_return_data):
        login, password, first_name = create_new_courier_and_return_data
        payload = {
            "login": login,
            "password": ""
